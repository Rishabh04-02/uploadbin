...
<label for="username">
Username or Email </label></br></br>
<input type="text" class="email_user" name="username" id="username"/><br/><br/>
<label for="password">
Password </label></br></br>
<input type="password" class="password_user" id="password" name="password"><br/><br/>
